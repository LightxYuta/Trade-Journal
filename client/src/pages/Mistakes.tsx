    ...
    <div className="p-6">
      ...
      <div className="mt-8">
        <h2 className="text-xl font-semibold mb-3">
          Scenario analysis - What if you were not a retard.
        </h2>
          ...
          return (
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(180deg, rgba(24,16,32,0.92), rgba(16,12,24,0.96))",
                boxShadow:
                  "0 8px 40px 0 rgba(139,92,246,0.10), 0 1.5px 0 0 rgba(139,92,246,0.10)",
              }}
            >
              ...
              <div className="mb-2 text-xs opacity-70">
                Current filtered trades vs. the same dataset excluding mistakes
                (including{" "}
                      ...
                      return (
                        <tr
                          ...
                          className={`rounded-lg ${
                            idx % 2 === 0 ? "bg-[rgba(139,92,246,0.04)]" : ""
                          }`}
                        >
                          <td className="p-3 text-center text-xs text-[#b8b8ff] font-mono">
                            {idx + 1}
                          </td>
                          <td className="p-3 opacity-80 font-medium">{r.label}</td>
                          <td className="p-3 font-mono text-center text-[#cfcfcf]">
                            {r.a}
                          </td>
                          <td
                            className={`p-3 font-mono text-center transition-all duration-200 ${highlight}`}
                          >
                            {r.b}
                            {icon}
                          </td>
